package com.n11.bootcamp.aopornek.aspect;
...
public class ServiceAspect {
    ...
    @Before("execution(* com.n11.bootcamp.aopornek.service.MessageService.mesajVer(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.n11.bootcamp.aopornek.service.MessageService.mesajVer(..))",
            returning="retVal")
